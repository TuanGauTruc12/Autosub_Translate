...
public class AutoSub extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(prcbLoading, javax.swing.GroupLayout.DEFAULT_SIZE, 378, Short.MAX_VALUE)
                .addContainerGap())
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (txtPath.getText().isEmpty()) {
            ...
            Thread thread = new Thread(new AutosubController(prcbLoading, fileName, languege.getLanguegeCode(), fileDirectory, this, width, height));
            thread.start();
        }
